...
export function ProductCard({ id, name, price, imageUrl, categoryName }: ProductCardProps) {
    ...
    return (
        <div className="group relative rounded-xl bg-card p-4 shadow-sm hover:shadow-md transition-shadow duration-300 border border-border/50">
            ...
            <div className="space-y-1">
                ...
                <p className="text-lg font-bold text-foreground">MAD {price.toFixed(2)}</p>
            </div>
